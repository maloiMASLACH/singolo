 ...
 horiz.addEventListener('click', () => {
     if (shadow_H.style.display == "none") shadow_H.style.display = "block";
     else shadow_H.style.display = "none";
 
 });
 vertic.addEventListener('click', () => {
     if (shadow_V.style.display == "none") shadow_V.style.display = "block";
     else shadow_V.style.display = "none";
